...
| `indexTestFiles()` | Creates a temp [RagDB](../glossary.md#ragdb) instance and indexes fixture files |
...
- **Integration-heavy**: Most tests create real [RagDB](../glossary.md#ragdb) instances backed by real SQLite databases with real [embeddings](../glossary.md#embedding). There are few mocks.
- **Coverage**: 193 tests with 504 `expect()` calls across 24 test files.
