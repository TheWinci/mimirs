...
`summary`. Rather than read fixed argument positions, the handler scans every
argument after the subcommand and collects only the non-flag tokens: any token in
